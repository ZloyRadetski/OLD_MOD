...
public abstract class EntityRendererManagerMixin {
   ...
   private static double pmOverrideShadowPositionX(double factor, double o, double n) {
      return DuplicateEntityRenderer.entityPosOverride != null ? DuplicateEntityRenderer.entityPosOverride.x : MathHelper.func_219803_d(factor, o, n);
   }
   ...
   private static double pmOverrideShadowPositionY(double factor, double o, double n) {
      return DuplicateEntityRenderer.entityPosOverride != null ? DuplicateEntityRenderer.entityPosOverride.y : MathHelper.func_219803_d(factor, o, n);
   }
   ...
   private static double pmOverrideShadowPositionZ(double factor, double o, double n) {
      return DuplicateEntityRenderer.entityPosOverride != null ? DuplicateEntityRenderer.entityPosOverride.z : MathHelper.func_219803_d(factor, o, n);
   }
   ...
   private void pmOverrideShadowRendering(MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, Entity entity, float strength, float partialTicks, IWorldReader worldReader, float radius) {
      if (DuplicateEntityRenderer.entityShadowTransformOverride != null) {
         ...
         matrixStack.func_227866_c_().func_227870_a_().func_226595_a_(DuplicateEntityRenderer.entityShadowTransformOverride);
      }

      func_229096_a_(matrixStack, renderTypeBuffer, entity, strength, partialTicks, worldReader, radius);
   }
}
